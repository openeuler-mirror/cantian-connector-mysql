...
void tse_set_mysql_read_only() {
  if(is_starting() || is_initialize()) {
    ...
    tse_log_system("[Disaster Recovery] ctc_set_sys_var: super_read_only: %s", local_req.user_ip);
  }
}
...
void tse_reset_mysql_read_only() { 
  if(is_starting() || is_initialize()) {
    ...
    tse_log_system("[Disaster Recovery] ctc_set_sys_var: super_read_only: %s", local_req_sro.user_ip);
    ...
    tse_log_system("[Disaster Recovery] ctc_set_sys_var: super_read_only: %s", local_req_ro.user_ip);
  }
}
