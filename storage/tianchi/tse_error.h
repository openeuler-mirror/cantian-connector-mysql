...
*/
#ifndef __TSE_ERROR_H__
#define __TSE_ERROR_H__
...
typedef enum en_errno {
  ...
  ERR_EXCEED_MAX_CASCADE_DEPTH = 1124,
  ...
  TSE_DDL_VERSION_NOT_MATCH = 9999,
} ct_errno_t;

#define convert_tse_error_code_to_mysql(error) convert_tse_error_code_to_mysql_impl(error, __func__, __LINE__)
