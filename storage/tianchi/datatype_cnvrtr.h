...
#define TSE_LOB_LOCATOR_BUF_SIZE (uint32)4012
#define TSE_LOB_MAX_INLINE_SIZE (TSE_LOB_LOCATOR_BUF_SIZE - offsetof(lob_locator_t, data))
...
#define TSE_DDL_MAX_VARCHAR_COLUMN_SIZE 8000
#define VARCHAR_AS_BLOB(len) ((len) > TSE_DDL_MAX_VARCHAR_COLUMN_SIZE)
...
typedef struct st_mysql_to_cantian_field_convert {
  ...
  enum_tse_ddl_field_types ddl_field_type;
} field_cnvrt_aux_t;
...
bool tse_datetime_with_no_zero_in_date_to_timeval(const MYSQL_TIME *ltime, const Time_zone &tz,
