...
/* class for the the tse part table handler */
...
*/
class ha_tsepart : public ha_tse,
                   public Partition_helper,
                   public Partition_handler {
 public:
  ha_tsepart(handlerton *hton, TABLE_SHARE *table_arg);
  ...
  */
  ...
  ulonglong table_flags() const override {
    return (ha_tse::table_flags() | HA_CAN_REPAIR);
  }
 ...
 protected:
  ...
  /** Pointer to Tsepart_share on the TABLE_SHARE. */
  Tsepart_share *m_part_share;
